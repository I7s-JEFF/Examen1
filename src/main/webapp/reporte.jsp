...
<body>
 ...
 <section>
       		 		 <%
					    String idCatStr = request.getParameter("cmbCategoria");
					    if (idCatStr != null) {
					        try {
					            int idCat = Integer.parseInt(idCatStr);
					            Producto pr = new Producto();
					            out.print(pr.buscarProductoCategoria(idCat));
					        } catch (NumberFormatException e) {
					            out.print("ID de categoría no válido.");
					        }
					    } else {
					        out.print("Por favor selecciona una categoría.");
					    }
					%>
					
					<div style="text-align: center; margin-top: 20px;">
					    <form action="categorias.jsp" method="get">
					        <input type="submit" value="Volver a Categorias" />
					    </form>
					</div>
